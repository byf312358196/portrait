...
import com.byf.map.BrandLikeMap;
import com.byf.reduce.BrandLikeReduce;
import com.byf.reduce.BrandLikeSink;
...
import com.byf.kafka.KafkaEventSchema;
import javax.annotation.Nullable;

public class BrandlikeTask {
    public static void main(String[] args) {
        // parse input arguments
        args = new String[]{"--input-topic","scanProductLog","--bootstrap.servers","192.168.0.108:9092","--zookeeper.connect","192.168.0.108:2181","--group.id","youfan"};
